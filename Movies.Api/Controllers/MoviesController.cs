...
public class MoviesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll([FromQuery] GetAllMoviesRequest request, CancellationToken token)
    {
        ...
        var response = movies.MapToResponse(options.Page, options.PageSize, count);

        return Ok(response);
    }

    [Authorize(AuthConsts.TrustedMemberPolicyName)]
    ...
    [Authorize(AuthConsts.AdminUserPolicyName)]
